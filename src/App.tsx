                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-x-4 gap-y-6">
                      {searchResults.map((item) => (
                          <div
                              ...
                              className="relative rounded-xl overflow-hidden aspect-[2/3] border border-zinc-900 bg-zinc-950 group cursor-pointer hover:border-red-650 transition-all hover:-translate-y-1"
                          >
                            <img
                                src={
                                  item.poster_path
